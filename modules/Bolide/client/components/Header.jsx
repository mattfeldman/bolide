        ...
        <div className="ui center aligned header-wrapper">
            ...
            <div className="ui page grid">
                <div className="ui inverted center labeled aligned secondary pointing menu">
                    ...
                    <Link to="/scene_select" activeClassName="active" className="item"><i className="desktop icon"></i> Scenes</Link>
                    <Link to="/scenes" activeClassName="active" className="item"><i className="camera icon"></i>Edit Scenes</Link>
